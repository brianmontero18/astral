...
| [`remote-mcp-implementation-recon-plan.md`](remote-mcp-implementation-recon-plan.md) | Reconocimiento del codebase y slices propuestos para implementar Remote MCP sin romper chat/auth existentes. |
