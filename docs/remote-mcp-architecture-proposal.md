...
**Estado**: propuesta con Slices 0-5 cerrados; `ask_astral_guide_v1` implementada en modo `mcp_read_only`; tools deterministicas HD implementadas con `mcp:read_hd`.
**Fecha**: 2026-05-17.
