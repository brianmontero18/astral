...
const profile = {
  ...
  humanDesign: {
    ...
    design: { date: "1988-11-20T09:00:00.000Z" },
    variables: {
    ...
    channels: [{ id: "5-15", name: "Canal del Ritmo", circuit: "Collective" }],
    activatedGates: [
      {
        number: 5,
        line: 1,
    ...
    undefinedCenters: ["Head", "Ajna", "Throat", "Spleen", "SolarPlexus", "Heart", "Root"],
  },
};
