 ...
 *
 *   parseHdSummaryFromText — labels en los 3 formatos reales
 *   (MyHumanDesign EN, Genetic Matrix EN, Genetic Matrix ES).
 *   Regresión de astral-86a (strings vacíos en formato ES).
 *
 * (Tests del Vision fallback eliminados en astral-1c6 junto con
 *  toda la rama Vision/LLM de extraction-service.ts.)
 */
